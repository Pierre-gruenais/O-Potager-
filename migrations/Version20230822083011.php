 ...
 */
final class Version20230822083011 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE garden ADD user_id INT NOT NULL, ADD state VARCHAR(128) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE garden DROP user_id, DROP state');
    }
}
